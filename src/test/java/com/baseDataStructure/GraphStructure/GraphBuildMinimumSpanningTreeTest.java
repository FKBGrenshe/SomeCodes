...
import com.baseDataStructure.GraphStrucuture.Kruskal;
 ...
 */
public class GraphBuildMinimumSpanningTreeTest {
    ...
    @Test
    void kruskalTest(){
        PriorityQueue<Kruskal.KruskalEdge> graph = buildKruskalGraph();
        Kruskal.kruskal(7,graph);
    }

    private static PriorityQueue<Kruskal.KruskalEdge> buildKruskalGraph(){
        ...
        PriorityQueue<Kruskal.KruskalEdge> queue = new PriorityQueue<>(List.of(
                new Kruskal.KruskalEdge(vertices, 0, 1, 2),
                new Kruskal.KruskalEdge(vertices, 0, 2, 4),
                new Kruskal.KruskalEdge(vertices, 0, 3, 1),
                new Kruskal.KruskalEdge(vertices, 1, 3, 3),
                new Kruskal.KruskalEdge(vertices, 1, 4, 10),
                new Kruskal.KruskalEdge(vertices, 2, 3, 2),
                new Kruskal.KruskalEdge(vertices, 2, 5, 5),
                new Kruskal.KruskalEdge(vertices, 3, 4, 7),
                new Kruskal.KruskalEdge(vertices, 3, 5, 8),
                new Kruskal.KruskalEdge(vertices, 3, 6, 4),
                new Kruskal.KruskalEdge(vertices, 4, 6, 6),
                new Kruskal.KruskalEdge(vertices, 5, 6, 1)
        ));
